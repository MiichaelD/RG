...
public class ServerConn{
	...
	public static boolean isNetworkAvailable() {
		...
		= (ConnectivityManager) Main.instance.getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	public static boolean haveNetworkConnection() {
		ConnectivityManager cm = (ConnectivityManager) Main.instance.getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	public static HttpURLConnection Connect(int mMethod, String mUrl, String query)throws Exception{
		...
		if(Main.D){
			Log.v(Main.TAG+"-srvConn","Opening Connection("+mMethod+") to url: "+mUrl+"?"+query);	
		}

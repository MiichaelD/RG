...
import com.webs.itmexicali.rg.BattleShock.comm.ServerConn;
...
public class BitmapLoader {
	...
	public static Bitmap resizeImage(Context ctx, String URL, float w, float h) {
		...
		try {
			...
			if (Main.D){
				Log.e(Main.TAG+" - BitmapLoader","Problem fetching Bitmap from: "+URL);
				e.printStackTrace();
			}
			Log.e(Main.TAG+" - BitmapLoader","loading default Bitmap for: " + URL);
			BitmapOrg = BitmapFactory.decodeResource(ctx.getResources(),R.drawable.realgamingh);
		}

...
import com.webs.itmexicali.rg.BattleShock.DeviceListActivity;
...
public class BlueConn {
    ...
    //this class TAG
    private static final String TAG = Main.TAG+"-BlueConn";
   ...
   public void handleMessage(Message msg) {
           ...
           case MESSAGE_STATE_CHANGE:
               if(Main.D) Log.i(TAG, "MESSAGE_STATE_CHANGE: " + msg.arg1);
               switch (msg.arg1) {
    ...
    public static void ensureDiscoverable(Context ctx) {
        if(Main.D) Log.d(TAG, "ensure discoverable");
    ...
    public static void requestBluetoothEnabled(Activity activity){
        ...
        if (getBlueAdapter().isEnabled()) { 
        	...
        	if(Main.D) Log.e(TAG, " BLUETOOTH IS NOT ENABLED");
            Intent enableIntent = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
            activity.startActivityForResult(enableIntent, Main.REQUEST_ENABLE_BT);
